...
from frameworks.yolov7.utils.datasets import LoadStreams, LoadImages
from frameworks.yolov7.utils.general import (
    check_img_size, non_max_suppression, apply_classifier,
    scale_coords, xyxy2xywh, strip_optimizer, set_logging, increment_path
)
from frameworks.yolov7.utils.plots import plot_one_box
from frameworks.yolov7.utils.torch_utils import (
        ...
        for i, det in enumerate(pred):
            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    results.append({"box": xyxy, "confidence": float(conf), "class": names[int(cls)]})
